...
from model.mask import get_pad_mask, get_subsequent_mask
...
class Transformer(nn.Module):
    ...
    def forward(self, src_seq, trg_seq):
        ...
        dec_outs = self.decoder(trg_seq, enc_outs, mask_1, mask_2) # [batch, seq_len, d_model]
